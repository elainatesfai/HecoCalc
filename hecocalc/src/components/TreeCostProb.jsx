  ...
  @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400&display=swap');
      ...
      <table className="table-box1"> 
        ...
        <tbody>
          ...
          <tr>
            <td></td>
            <td></td>
            <td><button className="Link" onClick={()=> probIsOpen(true)}>View More</button></td>
            </tr>           
        </tbody>
      </table>
        ...
        <tbody>
          ...
          <tr>
           ...
           <tr>
            <td></td>
            <td></td>
            <td><button className="Link" onClick={()=> costIsOpen(true)}>View More</button></td>
            </tr>      
        </tbody>
      </table>
      ...
      <table className ="table-box3">
        <thead>
          <tr>
          <th></th>
          <th><button className="btn-cost-qalys">Cost/QALYs</button></th>
          </tr>
        </thead>
